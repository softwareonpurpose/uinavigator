...
@Test
public class WebUiGetElementByLocatorAttributeNonExistentAttributeTests {
    ...
    public void testExecute_nonexistentAttribute() {
        ...
        final WebUiGetElementByLocatorAttribute getBehavior = WebUiGetElementByLocatorAttribute.getInstance(
