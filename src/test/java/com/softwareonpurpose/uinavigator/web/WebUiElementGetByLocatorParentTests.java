...
@Test
public class WebUiElementGetByLocatorParentTests {
    ...
    public void testConstructor_bodyTagLocatorNullParent() {
        ...
        Class<WebUiElementGetByLocatorParent> expected = WebUiElementGetByLocatorParent.class;
        //noinspection ConstantConditions,rawtypes
        Class actual = WebUiElementGetByLocatorParent
    ...
    public void testConstructor_selectTagLocatorNullParent() {
        ...
        final WebUiElementGetByLocatorParent getElement =
                WebUiElementGetByLocatorParent.getInstance(description, UiLocatorType.TAG, locatorValue, getParent);
    ...
    public void testConstructor_nameLocatorNullParent() {
        ...
        Class<WebUiElementGetByLocatorParent> expected = WebUiElementGetByLocatorParent.class;
        //noinspection ConstantConditions
        final WebUiElementGetByLocatorParent getElement = WebUiElementGetByLocatorParent
