...
@Test
public class WebUiElementGetByLocatorAttributeNonExistentAttributeTests {
    ...
    public void testExecute_nonexistentAttribute() {
        ...
        final WebUiElementGetByLocatorAttribute getBehavior = WebUiElementGetByLocatorAttribute.getInstance(
