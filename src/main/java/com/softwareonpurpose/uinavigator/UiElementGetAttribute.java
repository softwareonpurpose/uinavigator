 ...
 */
public abstract class UiElementGetAttribute {
    protected final UiElementGet getBehavior;

    protected UiElementGetAttribute(UiElementGet getBehavior) {
        this.getBehavior = getBehavior;
    }

    public static UiElementGetAttribute getInstance(UiElementGet getElement) {
