 ...
 */
public abstract class UiElementSet {
    protected final UiElementGet getBehavior;

    protected UiElementSet(UiElementGet getBehavior) {
        this.getBehavior = getBehavior;
    }

    public static UiElementSet getSelectInstance(UiElementGet getBehavior) {
        return new WebSelectSet(getBehavior);
    }

    public static UiElementSet getInstance(UiElementGet getBehavior) {
