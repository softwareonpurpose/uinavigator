 ...
 */
public abstract class UiElementGetText {
    protected final UiElementGet getBehavior;

    protected UiElementGetText(UiElementGet getBehavior) {
        this.getBehavior = getBehavior;
    }

    public static UiElementGetText getSelectInstance(UiElementGet getElement) {
        return new WebSelectGetText(getElement);
    }

    public static UiElementGetText getInstance(UiElementGet getElementBehavior) {
