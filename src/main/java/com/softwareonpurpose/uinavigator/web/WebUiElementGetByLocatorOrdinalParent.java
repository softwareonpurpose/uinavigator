...
public class WebUiElementGetByLocatorOrdinalParent extends WebUiElementGet {
    private final Integer ordinal;
    private final WebUiElementGet getParent;

    private WebUiElementGetByLocatorOrdinalParent(
            String description, By locator, Integer ordinal, WebUiElementGet getParent) {
        super(description, locator);
        this.ordinal = ordinal;
        this.getParent = (new By.ByTagName("body").equals(locator)) ? null : getParent;
    }

    public static WebUiElementGetByLocatorOrdinalParent getInstance(
            String description, String locatorType, String locatorValue,
            Integer ordinal, WebUiElementGet getParent) {
        return new WebUiElementGetByLocatorOrdinalParent(
