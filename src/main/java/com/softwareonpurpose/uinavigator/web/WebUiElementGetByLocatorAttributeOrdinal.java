...
public class WebUiElementGetByLocatorAttributeOrdinal extends WebUiElementGet {
    private final String attribute;
    private final String attributeValue;
    private final Integer ordinal;

    private WebUiElementGetByLocatorAttributeOrdinal(String description, By locator, String attribute, String attributeValue, Integer ordinal) {
    ...
    public static WebUiElementGetByLocatorAttributeOrdinal getInstance(
            String description, String locatorType, String locatorValue,
            String attribute, String attributeValue, Integer ordinal) {
        return new WebUiElementGetByLocatorAttributeOrdinal(
