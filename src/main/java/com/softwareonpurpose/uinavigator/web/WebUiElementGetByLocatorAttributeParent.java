...
public class WebUiElementGetByLocatorAttributeParent extends WebUiElementGet {
    private final String attribute;
    private final String attributeValue;
    private final WebUiElementGet getParent;

    private WebUiElementGetByLocatorAttributeParent(
    ...
    public static WebUiElementGetByLocatorAttributeParent getInstance(
        ...
        return new WebUiElementGetByLocatorAttributeParent(
