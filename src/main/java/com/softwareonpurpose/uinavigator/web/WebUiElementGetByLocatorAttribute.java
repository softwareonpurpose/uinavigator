...
public class WebUiElementGetByLocatorAttribute extends WebUiElementGet {
    private final String attribute;
    private final String attributeValue;

    private WebUiElementGetByLocatorAttribute(String description, By locator, String attribute, String attributeValue) {
        super(description, locator);
        this.attribute = attribute;
        this.attributeValue = attributeValue;
    }

    public static WebUiElementGetByLocatorAttribute getInstance(
            String description, String locatorType, String locatorValue, String attribute, String attributeValue) {
        return new WebUiElementGetByLocatorAttribute(
