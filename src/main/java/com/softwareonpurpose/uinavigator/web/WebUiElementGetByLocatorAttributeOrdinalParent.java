...
public class WebUiElementGetByLocatorAttributeOrdinalParent extends WebUiElementGet {
    private final String attributeValue;
    private final String attribute;
    private final Integer ordinal;
    private final WebUiElementGet getParent;

    private WebUiElementGetByLocatorAttributeOrdinalParent(
    ...
    public static WebUiElementGetByLocatorAttributeOrdinalParent getInstance(
        ...
        return new WebUiElementGetByLocatorAttributeOrdinalParent(
